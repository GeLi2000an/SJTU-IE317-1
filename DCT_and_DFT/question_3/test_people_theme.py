...
img_1 = cv2.imread(r'../figures/NataliePortman.jpg')
img_2 = cv2.imread(r'../figures/GalGadot.jpg')
...
cv2.imwrite("../figures_after/magnitude_1_and_phase_2_people_theme.jpg", img_1_r)
cv2.imwrite("../figures_after/magnitude_2_and_phase_1_people_theme.jpg", img_2_r)